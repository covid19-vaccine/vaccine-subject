# Generated by Django 3.1.4 on 2022-03-21 09:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part_supervised', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], max_length=3, verbose_name='Was the participant supervised 15 minutes post-dosing?')),
                ('adverse_event', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], max_length=3, verbose_name='Were any adverse events experienced?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('substance_hypersensitivity', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', max_length=3, verbose_name='Any hypersensitivity to the active substance or to any of the excipients?')),
                ...
                ('symptomatic_infections_experiences', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=20, verbose_name='Are you currently experiencing covid like symptoms')),
                ('symptomatic_infections_other', edc_base.model_fields.custom_fields.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If Other, specify ...')),
                ('childbearing_potential', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', max_length=150, verbose_name='Is woman of childbearing potential (WOCBP)?')),
                ('birth_control', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=150, verbose_name='Is the participant willing to use contraceptive consistent with standard of care for birth control from Day 0?')),
                ('birthcontrol_agreement', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=150, verbose_name='Is the participant willing to use contraceptive consistent with standard of care for 30 Days after the second dose?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date and Time')),
                ('hiv_testing_consent', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Do you consent to having HIV testing?')),
                ('prev_hiv_test', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], max_length=3, verbose_name='Have you tested for HIV before?')),
                ...
                ('rapid_test_done', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], max_length=3, verbose_name='Was a rapid test processed?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preg_test_type', models.CharField(blank=True, choices=[('urine', 'Urine'), ('hcg', 'HCG')], max_length=30, null=True, verbose_name='Type of pregnancy test performed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date and Time')),
                # ('primary_amenorrhea', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Does the participant have primary amenorrhea?')),
                ...
                ('contraceptive_usage', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], max_length=3, verbose_name='Using Contraception')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('throat_check', models.CharField(choices=[('normal', 'Normal'), ('abnormal', 'Abnormal')], max_length=20, verbose_name='Throat')),
                ('throat_description', models.TextField(blank=True, null=True, verbose_name='Abnormal, description of abnormality')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode_of_transport', models.CharField(blank=True, choices=[('public_transport', 'Public Transport'), ('private_transport', 'Private Transport')], max_length=30, verbose_name='Mode of Transport')),
        ...
        # ),
        # migrations.CreateModel(
        #     name='HistoricalVaccinationDetails',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Collection of vaccination details',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        # ),
        # migrations.CreateModel(
        #     name='HistoricalTargetedPhysicalExamination',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Targeted Physical Exam',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        #         ('device_modified', models.CharField(blank=True, max_length=10)),
        #         ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, db_index=True, editable=False, help_text='System auto field. UUID primary key.')),
        #         ('ae_number', models.PositiveIntegerField(verbose_name='AE number')),
        ...
        #         ('meddra_version', models.CharField(max_length=5, verbose_name='MedDRA version')),
        ...
        # ),
        # migrations.CreateModel(
        #     name='HistoricalSpecialInterestAdverseEvent',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Special Interest Adverse Event',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        #         ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, db_index=True, editable=False, help_text='System auto field. UUID primary key.')),
        #         ('ae_number', models.PositiveIntegerField(verbose_name='AE number')),
        #         ('sae_name', models.CharField(max_length=100, verbose_name='Adverse Event Reported Term')),
        #         ('sae_details', models.TextField(verbose_name='SAE Description')),
        #         ('dthcaus_1', models.TextField(blank=True, null=True, verbose_name='Primary cause of death')),
        #         ('dthcaus_2', models.TextField(blank=True, null=True, verbose_name='Secondary cause of death')),
        #         ('ae_sddat', models.DateField(blank=True, null=True, verbose_name='Date of death')),
        #         ('ae_sautop', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, verbose_name='Was an autopsy performed?')),
        #         ('ad', models.CharField(blank=True, max_length=10, null=True, verbose_name='Additional drug')),
        #         ('ae_caad', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, null=True, verbose_name='AE Caused by Additional Drug')),
        #         ('ad1', models.CharField(blank=True, max_length=10, null=True, verbose_name='Additional drug 1')),
        #         ('ae_caad1', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, null=True, verbose_name='AE Caused by Additional Drug 1')),
        #         ('ad2', models.CharField(blank=True, max_length=10, null=True, verbose_name='Additional drug 2')),
        #         ('ae_caad2', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, null=True, verbose_name='AE Caused by Additional Drug 2')),
        #         ('ae_smedca', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=10, verbose_name='SAE caused by other medication?')),
        #         ('ae_smed', models.CharField(blank=True, max_length=200, null=True, verbose_name='Other Medication')),
        #         ('ae_caussp', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=5, verbose_name='SAE caused by study procedure(s)?')),
        #         ('ae_sp', models.CharField(blank=True, max_length=200, null=True, verbose_name='Study Procedure(s)')),
        #         ('start_date', models.DateField(validators=[edc_base.model_validators.date.date_not_future], verbose_name='Date AE Met Criteria for Serious AE')),
        ...
        #         ('ae_sdth', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Results in death')),
        #         ('hospitalization', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Requires or prolong hospitalization?')),
        #         ('ae_scong', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=6, verbose_name='Was it a congenital anomaly or birth defect?')),
        #         ('ae_slife', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=6, verbose_name='Was it life-threatening')),
        #         ('ae_sdisab', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=6, verbose_name='Did it result in significant disability/incapacity? ')),
        #         ('ae_smie', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=6, verbose_name='Other medically important serious event')),
        #         ('admission_date', models.DateField(blank=True, null=True, validators=[edc_base.model_validators.date.date_not_future], verbose_name='Date of hospitalization')),
        #         ('discharge_date', models.DateField(blank=True, null=True, verbose_name='If hospitalized, Date of Discharge')),
        #         ('rationale', models.CharField(max_length=100, verbose_name="Investigator's rationale for Study Treatment being Related to the events")),
        #         ('describe_sae_treatmnt', models.TextField(blank=True, max_length=200, null=True, verbose_name='Describe treatment for event including medications')),
        #         ('test_performed', models.TextField(blank=True, max_length=200, null=True, verbose_name='List all diagnostic tests that were performed to confirm event')),
        #         ('additional_info', models.TextField(blank=True, max_length=200, null=True, verbose_name='Additional information (for example: history of presenting illness, course of illness, complications, risk factors and/or other contributing factors)')),
        #         ('event_abate', models.TextField(max_length=200, verbose_name='List all diagnostic tests that were performed to confirm event')),
        #         ('history_date', models.DateTimeField()),
        #         ('history_change_reason', models.CharField(max_length=100, null=True)),
        #         ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        #         ('history_id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
        ...
        # ),
        # migrations.CreateModel(
        #     name='HistoricalSeriousAdverseEvent',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Serious Adverse Event',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        # ),
        # migrations.CreateModel(
        #     name='HistoricalSampleCollection',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Sample Collection',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        # ),
        # migrations.CreateModel(
        #     name='HistoricalRapidHIVTesting',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Rapid HIV Testing',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Pregnancy Test',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        # ),
        # migrations.CreateModel(
        #     name='HistoricalPregnancyStatus',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Pregnancy Status',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Physical examination',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        # ),
        # migrations.CreateModel(
        #     name='HistoricalPersonalContactInfo',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Personal Contact Information',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        # ),
        # migrations.CreateModel(
        #     name='HistoricalDemographicsData',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        # ),
        # migrations.CreateModel(
        #     name='HistoricalCovid19SymptomaticInfections',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #         ('hospitalisation_visit', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=20, verbose_name='Any hospital/ inpatient/ emergency room visit?')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Covid19 Symptomatic Infections',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        #         ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
        #         ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date and Time')),
        #         ('covid_result', models.CharField(blank=True, choices=[('POS', 'Positive'), ('NEG', 'Negative'), ('IND', 'Indeterminate')], max_length=15, null=True, verbose_name='What was your covid 19 result?')),
        #         ('history_date', models.DateTimeField()),
        #         ('history_change_reason', models.CharField(max_length=100, null=True)),
        #         ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        #         ('history_id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical Covid19 Results',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        # ),
        # migrations.CreateModel(
        #     name='HistoricalCovid19PreventativeBehaviours',
        #     fields=[
        #         ('created', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('modified', models.DateTimeField(blank=True, default=edc_base.utils.get_utcnow)),
        #         ('user_created', edc_base.model_fields.userfield.UserField(blank=True, help_text='Updated by admin.save_model', max_length=50, verbose_name='user created')),
        ...
        #     ],
        #     options={
        #         'verbose_name': 'historical COVID Preventative Behaviours',
        #         'ordering': ('-history_date', '-history_id'),
        #         'get_latest_by': 'history_date',
        #     },
        #     bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        #         ('atc_code', models.CharField(blank=True, max_length=30, verbose_name='ATC code')),
        #         ('dose', models.DecimalField(blank=True, decimal_places=2, max_digits=4, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))], verbose_name='Dose')),
        ...
        #         ('device_modified', models.CharField(blank=True, max_length=10)),
        #         ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, db_index=True, editable=False, help_text='System auto field. UUID primary key.')),
        #         ('search_code', models.CharField(blank=True, max_length=100, null=True, verbose_name='Search MedDRA dictionary')),
        #         ('ae_number', models.PositiveIntegerField(verbose_name='AE Number')),
        #         ('ae_term', models.CharField(max_length=100, verbose_name='AE reported term')),
        #         ('ae_details', models.TextField(verbose_name='Details of the AE')),
        #         ('start_date', models.DateField(validators=[edc_protocol.validators.date_not_before_study_start, edc_base.model_validators.date.date_not_future], verbose_name='AE Start Date')),
        #         ('stop_date', models.DateField(blank=True, null=True, validators=[edc_base.model_validators.date.date_not_future], verbose_name='AE Stop Date')),
        ...
        #         ('study_treatmnt_rel', models.CharField(choices=[('related', 'Related'), ('not_related', 'Not Related')], max_length=15, null=True, verbose_name='Relationship to study treatment')),
        #         ('nonstudy_treatmnt_rel', models.CharField(choices=[('related', 'Related'), ('not_related', 'Not Related')], max_length=15, null=True, verbose_name='Relationship to non-study treatment')),
        #         ('studyproc_treatmnt_rel', models.CharField(choices=[('related', 'Related'), ('not_related', 'Not Related')], max_length=15, null=True, verbose_name='Relationship to study procedure')),
        #         ('outcome', models.CharField(blank=True, choices=[('C49498', 'Recovered/Resolved'), ('C49496', 'Recovering/Resolving'), ('C49495', 'Recovered/Resolved with sequelae'), ('C49494', 'Not recovered/Not resolved'), ('C48275', 'Fatal'), ('unknown', 'Unknown')], max_length=50, null=True, verbose_name='Outcome')),
        ...
        #         ('serious_event', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Was this considered to be a serious adverse event?')),
        #         ('investigation_product', models.CharField(max_length=20, verbose_name='Investigational Product')),
        #         ('action_taken', models.CharField(blank=True, choices=[('dose_not_changed', 'Dose not changed'), ('drug_withdrawal', 'Drug withdrawal'), ('N/A', 'N/A'), ('unknown', 'Unknown')], max_length=25, null=True, verbose_name='Action Taken, Investigational Product')),
        #         ('ctcae_grade', models.CharField(choices=[('mild', 'Mild (Grade 1)'), ('moderate', 'Moderate (Grade 2)'), ('severe', 'Severe (Grade 3)'), ('life_threatening', 'Life-threatening (Grade 4)'), ('fatal', 'Fatal (Grade 5)')], max_length=25, verbose_name='CTCAE Grade')),
        #         ('max_ctcae_grade', models.CharField(choices=[('mild', 'Mild (Grade 1)'), ('moderate', 'Moderate (Grade 2)'), ('severe', 'Severe (Grade 3)'), ('life_threatening', 'Life-threatening (Grade 4)'), ('fatal', 'Fatal (Grade 5)')], max_length=25, verbose_name='Maximum CTCAE Grade')),
        #         ('special_interest_ae', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='(If Yes, check all serious criteria that apply on the corresponding SAE form.)', max_length=3, null=True, verbose_name='Was the event an AE of special interest?')),
        #         ('medically_attended_ae', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Was the event a medically attended AE?')),
        ...
        #         ('hospitalized', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Was the participant hospitalized?')),
        #         ('treatment_given', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Was treatment given?')),
        ...
        #         ('ae_study_discontinued', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Did the AE cause the subject to discontinue from the study?')),
        #         ('discontn_dt', models.DateField(blank=True, null=True, verbose_name='Date of discontinuation')),
        #         ('covid_related_ae', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Is this a covid-19 related AE?')),
        #         ('ae_rel', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Reasonable possibility AE caused by IP?')),
        #         ('pt_name', models.CharField(max_length=200, verbose_name='MedDRA preferred term name')),
        #         ('pt_code', models.PositiveIntegerField(verbose_name='MedDRA preferred term code')),
        #         ('llt_code', models.PositiveIntegerField(verbose_name='MedDRA lowest level term code')),
        #         ('llt_name', models.CharField(max_length=200, verbose_name='MedDRA lowest level term name')),
        #         ('hlt_code', models.PositiveIntegerField(verbose_name='MedDRA high level term code')),
        #         ('hlt_name', models.CharField(max_length=200, verbose_name='MedDRA high level term name')),
        #         ('hlgt_code', models.PositiveIntegerField(verbose_name='MedDRA high level group term code')),
        #         ('hlgt_name', models.CharField(max_length=200, verbose_name='MedDRA high level group term name')),
        #         ('soc_code', models.PositiveIntegerField(verbose_name='MedDRA system organ class code')),
        #         ('soc_name', models.CharField(max_length=200, verbose_name='MedDRA system organ class name')),
        #         ('meddra_v', models.CharField(max_length=5, verbose_name='MedDRA version')),
        #         ('ctcae_v', models.CharField(max_length=5, verbose_name='CTCAE version')),
        #         ('history_date', models.DateTimeField()),
        #         ('history_change_reason', models.CharField(max_length=100, null=True)),
        #         ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        #         ('history_id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_info', models.TextField(blank=True, max_length=200, null=True, verbose_name='Additional information (for example: history of presenting illness, course of illness, complications, risk factors and/or other contributing factors)')),
                ('event_abate', models.TextField(max_length=200, verbose_name='List all diagnostic tests that were performed to confirm event')),
                ('sae_criteria', models.ManyToManyField(to='esr21_subject.SAECriteria', verbose_name='SAE Criteria')),
